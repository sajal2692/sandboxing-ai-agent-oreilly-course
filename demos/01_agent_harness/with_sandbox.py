...
""",
        ...
        settings=json.dumps({
            ...
            "sandbox": {
                ...
                "filesystem": {
                    "denyRead": [str(DEMO_DIR)],
                    "allowRead": [
                        str(DEMO_DIR / "data"), str(OUTPUT_DIR),
                        # Python's virtual environment and standard library.
                        sys.prefix, sys.base_prefix,
                    ],
                    "allowWrite": [str(OUTPUT_DIR)],
                },
            },
        }),
